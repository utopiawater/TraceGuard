...
class Settings(BaseModel):
    ...
    live_poll_interval_seconds: float = float(os.getenv("TRACEGUARD_LIVE_POLL_INTERVAL_SECONDS", "1"))
    live_micro_batch_size: int = int(os.getenv("TRACEGUARD_LIVE_MICRO_BATCH_SIZE", "200"))
    demo_bundle_path: str = os.getenv("TRACEGUARD_DEMO_BUNDLE_PATH", "data/testbed_bundles/attack_demo.zip")
