...
export function AgentsPage(){
  ...
  return <><PageHeader title="Agent 调查中心" description="从既有攻击链启动受约束调查，查看任务编排、只读工具调用、结构化 Findings 与证据校验结果。" aside={runId ? <span className="freshness">任务 {runId}</span> : undefined} />
